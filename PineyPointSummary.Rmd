...
## see if any groups are correlated
corrplot()
...
longPhyto_sites<-filter(longPhyto, Location=="Piney Point"| Location=="Joe Bay"| Location=="Bishop Harbor"|Location=="St. Joseph Sound")

longPhyto_sites$Location<-ordered(longPhyto_sites$Location, c("St. Joseph Sound", "Piney Point", "Bishop Harbor", "Joe Bay"))


sites<-ggplot(longPhyto_sites, aes(x=`Date of Sample collection`, y=Biomass_ugC_ml, fill=factor(Group)))+
...
chl<-read_excel("../Data/Phlips/Piney Point Chl for Elise 09 17 2021.xlsx")
