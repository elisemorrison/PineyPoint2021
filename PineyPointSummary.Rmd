...
ggsave("./Figures/Frontiers_2022/POM_all.png", POM_plot, width=10, height=8)
...
write.csv(noNA_onlysites_summary, "./Tables/Temp_tables/POM_summary.csv")
...
d13C<-ggplot(noNA_noBlank, aes(Date, `d13C (permil, vs VPDB)`))+
  geom_point()+
  facet_wrap(.~Location)+
  theme_cowplot(font_size = 8)+
   panel_border(color="black")+
  geom_hline(yintercept = -14.01:-15.82, color="red")
...
d15N<-ggplot(noNA_noBlank, aes(Date, `d15N (permil, vs AIR)`))+
  geom_point()+
  facet_wrap(.~Location)+
  theme_cowplot(font_size = 8)+
   panel_border(color="black")+
 geom_hline(yintercept = -19.24:-17.36, color="red")
...
pp<-read_excel("../../Data/Sonde_data_from_Alteri_gdrive/Sonde_data_consolidated_April_to_July.xlsx", sheet = 1)
ssjs<-read_excel("../../Data/Sonde_data_from_Alteri_gdrive/Sonde_data_consolidated_April_to_July.xlsx", sheet = 2)
bh<-read_excel("../../Data/Sonde_data_from_Alteri_gdrive/Sonde_data_consolidated_April_to_July.xlsx", sheet = 3)
jb<-read_excel("../../Data/Sonde_data_from_Alteri_gdrive/Sonde_data_consolidated_April_to_July.xlsx", sheet = 4)
