...
Appears to be related to the site location, SSJS3 is the northermost site
...
ggplot(nutrients_onlysites, aes(`Salinity (ppt)`, `OrthoP (ug/L)`, color=Location))+
  geom_point()+
  geom_smooth(method='lm', se=FALSE)+
