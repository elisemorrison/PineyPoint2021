...
Coastal ecosystems are increasingly subjected to chronic and episodic nutrient loading, largely driven by anthropogenic activities. Excess nutrients in the coastal zone can decrease water quality, increase phytoplankton and macroalgae biomass, and, in some circumstances, result in declines in seagrass cover. In spring 2021, a failure of the liner at the Piney Point facility, a decommissioned fertilizer facility, prompted the controlled release of an estimated 215 million gallons of mixed process and dredge water into Tampa Bay, from March 29th to April 9th. This discharge was high in total nitrogen and total phosphorus, which were predominantly in the forms of ammonium/ammonia and orthophosphate. Here, we address the following research questions: (1) What was the effect of the N- and P-rich discharge on nutrient cycling within Tampa Bay; and (2) What changes in phytoplankton community composition and trophic status were seen over the course of the summer, following the discharge? We hypothesized that the fate of the nitrogen- and phosphorus-rich discharge water included a combination of the following processes: assimilation of nutrients by some phytoplankton and macroalgae, transport throughout and export outside of the bay, and some amount of deposition into bay sediments. Here, we address these questions through the evaluation of water column nutrients, phytoplankton community analysis, and stable isotopes of particulate organic matter, seagrasses, and macroalgae, coupled with continuous water quality measurements. Four sites were selected for continuous monitoring and included a region adjacent to the discharge site (Piney Point), two back bay regions, one of which was a site of previous discharge in 2003 (Bishop Harbor and Joe Bay), and one reference site located outside of the bay (St. Joseph Sound).
...
### Study site
Samples were collected on a bi-weekly basis from April 2021 until [present]. Four monitoring sites were selected, and included a 
### Bulk measures
Particulate organic matter (POM) was collected on pre-combusted 25mm diameter glass fiber filters (GF/F; nominal pore size 0.7um). Seagrass and macroalgae tissues were rinsed with deionized water after collection, and then frozen. Tissues and filters were freeze dried then analyzed for total carbon, total nitrogen, delta 13C, and d15N.

Certified analyses were conducted at the University of Florida's Analytical Research Laboratory for total phosphorus (TP; EPA Method 365.1), orthophosphate (OrthoP; EPA Method 365.1), total kjeldahl nitrogen (TKN; EPA 351.2), ammonium-N (NH4; EPA 350.1) and nitrate+nitrite (NOx; EPA 353.2).
...
ggplot(noNA_date, aes(`d13C (permil, vs VPDB)`, `d15N (permil, vs AIR)`, color=Location))+
  geom_point(size=4)+
...
POM_CN_d15N<-ggplot(noNA_onlysites, aes(CN, `d15N (permil, vs AIR)`))+
